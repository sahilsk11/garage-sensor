...
class Relay:
    def __init__(self, trig_pin=14, on_level='HIGH', gpio_mode=None, gpio_warnings=None):
...
class DistanceMeasurer:
    def __init__(self, trig_pin=15, echo_pin=16, settle_time=1, range_min=2, range_max=500, gpio_mode=None, gpio_warnings=None):
        self.trig_pin = trig_pin
